...
export const { setLoading, getProduct, addCart, addWishList, deleteCart, filterProducts, sortByPriceUpProducts, sortByPriceDownProducts, sortByNewProducts, logout } = appSlice.actions;
